{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      # Unpinned again 2026-09-02: `release` now ships lts 6.18.48, past the
      # 6.18.44 amdgpu fix for the niri redraw flicker that forced the
      # 6.18.40 pin — see docs/amdgpu-6.18.42-redraw-flicker.md.
