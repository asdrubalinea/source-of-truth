...
(use-package general
  ...
  (my/leader
    ...
    "p p" '(projectile-switch-project              :wk "switch")
    "p f" '(projectile-find-file                   :wk "find file")
    "p b" '(projectile-switch-to-buffer            :wk "buffer")
    ...
    "p R" '(projectile-replace-regexp              :wk "replace regexp")
    "p s" '(projectile-run-shell-command-in-root   :wk "shell cmd in root")
    "p T" '(projectile-test-project                :wk "test")
    ...
    "c"   '(:ignore t :wk "code")
    "c a" '(lsp-execute-code-action  :wk "actions")
    ...
    "c S" '(consult-lsp-file-symbols :wk "file symbols")
    "c e" '(consult-flycheck         :wk "diagnostics")
    "c i" '(lsp-ui-imenu             :wk "imenu (peek)")
